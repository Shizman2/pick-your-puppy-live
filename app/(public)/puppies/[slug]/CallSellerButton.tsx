 ...
 */
export default function CallSellerButton({ phone, puppyId }: { phone: string | null; puppyId?: string }) {
  ...
  return (
    <a href={`tel:${digitsOnly}`} className="call-seller-btn" onClick={() => trackCta("call_now", puppyId)}>
