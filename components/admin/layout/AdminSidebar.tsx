...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: "breeders", label: "Breeders", href: null, icon: <Icon path="M8 12a3 3 0 100-6 3 3 0 000 6zM16 12a3 3 0 100-6 3 3 0 000 6zM2 20c0-3 3-5 6-5s6 2 6 5M10 20c0-3 3-5 6-5s6 2 6 5" /> },
  ...
  { key: "tasks", label: "Tasks", href: null, icon: <Icon path="M9 11l3 3L22 4M3 12v7a2 2 0 002 2h14a2 2 0 002-2v-7" /> },
