  ...
  return (
    <section className="partner-earn">
      ...
      <div className="partner-earn-decal">
        ...
        {/* Flowing text, no hardcoded <br> - letting the narrow column
            (see .partner-earn-decal's max-width) wrap it naturally
            into short lines is what gives the reference's handwritten-
            note look, rather than forcing one specific break point. */}
        <span>Same Puppies. More Happy Families.</span>
      </div>
    </section>
  );
}
